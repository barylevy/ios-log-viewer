            ...
            <div className="flex items-center overflow-x-auto p-2 pb-0">
                ...
                <div className="flex overflow-x-auto w-full">
                    {files.map((file, index) => (
                        <div
                            key={index}
                            className={`flex items-center gap-2 px-4 py-2 mx-1 rounded-t-lg border border-b-0 cursor-pointer whitespace-nowrap transition-all duration-200 ${activeFileIndex === index && !showingCombinedView
                    ...
                    {files.length > 1 && (
                        <div
                            className={`flex items-center gap-2 px-4 py-2 mx-1 rounded-t-lg border border-b-0 cursor-pointer whitespace-nowrap transition-all duration-200 ${showingCombinedView
